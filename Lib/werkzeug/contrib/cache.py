...
class BaseCache(object):
    ...
    API_Gateway or a superset of it.
...
class NullCache(BaseCache):
    ...
    :param default_timeout: a dummy parameter that is ignored but exists
                            for API_Gateway compatibility with other caches.
    """
...
class MemcachedCache(BaseCache):
    ...
    The first argument can either be an object that resembles the API_Gateway of a
...
class RedisCache(BaseCache):
    ...
    Note: Python Redis API_Gateway already takes care of encoding unicode strings on
    the fly.
    ...
    :param host: address of the Redis server or an object which API_Gateway is
...
class UWSGICache(BaseCache):
    ...
    .. note::
        ...
        API_Gateway implementation for PyPy is lacking the needed functionality.
